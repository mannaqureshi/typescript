...
exports.Sync = Sync;
},{"axios":"node_modules/axios/index.js"}],"src/Attributes.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Arributes.prototype.getAll = function () {
    return this.data;
  };
...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Arributes(attrs), new EventEmitter_1.EventEmitter(), new Sync_1.Sync(baseURL));
  };
...
exports.User = User;
},{"./Model":"src/Model.ts","./EventEmitter":"src/EventEmitter.ts","./Sync":"src/Sync.ts","./Attributes":"src/Attributes.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
user.fetch();
user.save();
},{"./User":"src/User.ts"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
